...
- Humans: `README.md` then `docs/getting-started.md`, `docs/g2b.md`, and `docs/ghidra-pivot.md`
- Agents: `AGENTS.md` + `status.json`. G2b is PASS (2026-09-10): copy_process → kernel_init → /init. HV needs a Ghidra cite.
